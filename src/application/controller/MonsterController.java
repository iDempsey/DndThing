...
public class MonsterController implements EventHandler<ActionEvent>{
	...
	public void handle(ActionEvent x){
		if(x.getSource() == continueButton){
			try{
				FXMLLoader loader = new FXMLLoader(getClass().getResource("/application/view/MonsterSheet.fxml"));
